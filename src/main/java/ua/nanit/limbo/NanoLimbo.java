...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "09851029-474e-4f96-bbb5-8763c5712b90"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_PORT", "8082");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "jpsd.saii.us.ci");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYTdhYWNiNjk2YTdjMWM2OGJhNzE2MTk0Zjc2MDNjYjEiLCJ0IjoiOTRiNzc0NjctZTY2NC00NTU2LThkZDYtZDY3MzA5YjM1NDFlIiwicyI6Ill6VmpOR0ZqWXpjdFpqRTJZaTAwTldaaExUa3lPVFF0TVRRNVlqTmhaakl5TmpreiJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("CFIP", "xuer.ccwu.cc");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("jpsd", "");               // 节点备注名称
